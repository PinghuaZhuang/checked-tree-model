(function (n, s) {
  ...
  function s(f, e, t, i, r) {
    if (i === 'm') throw new TypeError('Private method is not writable');
    if (i === 'a' && !r)
      throw new TypeError('Private accessor was defined without a setter');
    if (typeof e == 'function' ? f !== e || !r : !e.has(f))
      throw new TypeError(
        'Cannot write private member to an object whose class did not declare it',
      );
    return i === 'a' ? r.call(f, t) : r ? (r.value = t) : e.set(f, t), t;
  }
  var a, l, h, c;
  let d = {};
  function m(f, ...e) {
  ...
  class o {
    constructor(e, t) {
      a.set(this, !1),
        ...
        (this.childList = e.childList.map((i) => {
          const r = new o(i, this);
          return (
            this.map[r.id] != null && console.warn(`the same id. id: ${r.id}`),
            (this.map[r.id] = r),
            r
          );
        }));
    ...
    calcParentStatus() {
      ...
      const { childList: t } = e,
        { length: i } = t;
      if (i <= 0) return this;
      s(e, l, n(e, a, 'f'), 'f'), s(e, c, n(e, h, 'f'), 'f');
      const r = t.filter((p) => p.checked).length;
      return (
        r === i
          ? (s(e, a, !0, 'f'), s(e, h, !1, 'f'))
          : r > 0
