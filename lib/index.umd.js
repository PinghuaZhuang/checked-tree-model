(function (n, r) {
  ...
  class o {
    ...
    diff() {
      let e = c[this.id];
      return (
        n(this, h, 'f') !== n(this, a, 'f') &&
          ((e = e != null ? e : {}),
          (e.checked = n(this, a, 'f')),
          n(this, a, 'f') && (e.indeterminate = !1)),
        n(this, u, 'f') !== n(this, l, 'f') &&
          ((e = e != null ? e : {}), (e.indeterminate = n(this, l, 'f'))),
        e && (c[this.id] = e),
        e
      );
    }
    ...
    selectKeys(e) {
      ...
      return (
        e.forEach((i) => {
          m(t, this.setCheckedReturnDiff(i));
        }),
        t
      );
    }
    ...
    calcParentStatus() {
      ...
      const { childList: t } = e,
        { length: i } = t;
      if (i <= 0) return;
      r(e, h, n(e, a, 'f'), 'f'), r(e, u, n(e, l, 'f'), 'f');
