...
class m {
  constructor(e, t) {
    a.set(this, !1), f.set(this, !1), l.set(this, !1), c.set(this, !1), Object.defineProperty(this, "id", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: void 0
  ...
  diff() {
    let e = d[this.id];
    return h(this, f, "f") !== h(this, a, "f") && (e = e != null ? e : {}, e.checked = h(this, a, "f"), h(this, a, "f") && (e.indeterminate = !1)), h(this, c, "f") !== h(this, l, "f") && (e = e != null ? e : {}, e.indeterminate = h(this, l, "f")), e && (d[this.id] = e), e;
  }
  setChecked(e, t) {
    return s(this, f, h(this, a, "f"), "f"), s(this, a, e, "f"), e && this.setIndeterminate(!1, !0), this.diff() && this.parent && !t && this.calcParentStatus(), e ? this.each((i) => {
  ...
  setIndeterminate(e, t) {
    return s(this, c, h(this, l, "f"), "f"), s(this, l, e, "f"), e && !t && (s(this, f, h(this, a, "f"), "f"), s(this, a, !1, "f"), this.parent && this.parent.setIndeterminate(!0)), t || this.diff(), this;
  }
  ...
  selectKeys(e) {
    const t = this.clean();
    return e.forEach((i) => {
      o(t, this.setCheckedByIdReturnDiff(i));
    }), t;
  }
  getSelectKeys() {
    const e = [];
  ...
  calcParentStatus() {
    ...
    if (i <= 0)
      return this;
    s(e, f, h(e, a, "f"), "f"), s(e, c, h(e, l, "f"), "f");
  ...
  clean() {
    ...
    return Object.values(this.map).forEach((t) => {
      let i = e[t.id];
      t.checked && (i = i != null ? i : {}, i.checked = !1), t.indeterminate && (i = i != null ? i : {}, i.indeterminate = !1), i && (e[t.id] = i), s(t, f, s(t, a, !1, "f"), "f"), s(t, c, s(t, l, !1, "f"), "f");
    }), e;
  }
  each(e) {
...
a = /* @__PURE__ */ new WeakMap(), f = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap();
export {
  m as default
};
