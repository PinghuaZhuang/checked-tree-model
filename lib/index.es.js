...
class m {
  ...
  diff() {
    let e = d[this.id];
    return (
      h(this, l, 'f') !== h(this, a, 'f') &&
        ((e = e != null ? e : {}),
        (e.checked = h(this, a, 'f')),
        h(this, a, 'f') && (e.indeterminate = !1)),
      h(this, c, 'f') !== h(this, f, 'f') &&
        ((e = e != null ? e : {}), (e.indeterminate = h(this, f, 'f'))),
      e && (d[this.id] = e),
      e
    );
  }
  ...
  calcParentStatus() {
    ...
    const { childList: t } = e,
      { length: i } = t;
    if (i <= 0) return;
    s(e, l, h(e, a, 'f'), 'f'), s(e, c, h(e, f, 'f'), 'f');
